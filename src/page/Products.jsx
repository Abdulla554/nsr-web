...
const Products = () => {
  ...
  return (
    <div className="min-h-screen py-20 px-16" style={{ backgroundColor: '#1a1a2e' }}>
      <div className=" ">
        {/* Header */}
          ...
          {products.map((product, index) => (
            ...
            >
              ...
              <div
                ...
                style={{
                  background: 'linear-gradient(45deg, #749BC2, #2C6D90, #749BC2)',
                  animation: hoveredItem === product.id ? 'pulse 2s infinite' : 'none'
                }}
              ></div>

              {/* Card Content */}
              <div className="relative bg-white rounded-3xl overflow-hidden" style={{ backgroundColor: '#F9F3EF' }}>
                ...
                <div className="relative h-72   overflow-hidden">
                  ...
                  {product.discount && (
                    <div className="absolute top-4 left-4 z-20">
                      <div
                        className={`px-4 py-2 rounded-full text-white font-bold text-sm shadow-lg transform transition-all duration-300 ${hoveredItem === product.id ? 'scale-110 animate-pulse' : ''
                          }`}
                   ...
                   <div className="relative z-10 h-full flex items-center justify-center overflow-hidden">
                     ...
                     <img
                       ...
                       className={`w-full object-contain drop-shadow-2xl transform transition-all duration-700 absolute ${
                         hoveredItem === product.id ? 'opacity-0 scale-110' : 'opacity-100 scale-100'
                       }`}
                     />
                     ...
                     <img
                       ...
                       className={`w-full object-contain drop-shadow-2xl transform transition-all duration-700 absolute ${
                         hoveredItem === product.id ? 'opacity-100 scale-100' : 'opacity-0 scale-90'
                       }`}
                     />
                   </div>
                 ...
                 <div className="p-6">
                   ...
                   {/* Product Details */}
                   <p className="text-sm mb-4 line-clamp-2 opacity-70" style={{ color: '#1a1a2e' }}>
                     {product.details}
                   </p>
                ...
                <div
                  ...
                  style={{
                    background: 'linear-gradient(45deg, rgba(116, 155, 194, 0.1) 0%, rgba(44, 109, 144, 0.1) 100%)'
                  }}
                ></div>
              </div>
            </div>
